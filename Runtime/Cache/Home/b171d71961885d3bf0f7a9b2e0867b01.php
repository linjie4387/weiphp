...
<div class="login_header">
    ...
    <div class="log_wrap">
        <a href="/" title="微企联"><img class="logo" src="/Public/Home/images/logo.png"/></a>
        <!--
        <div class="nav_r">
            第一次使用微企联？<a href="<?php echo U('User/register');?>">立即注册</a>
        </div>
        -->
    </div>
...
<!-- 介绍 -->
    	...
    	<div class="top_content">
        	<div class="log_wrap">
            	<div class="top_content_r" style="display:none;">
    ...
    <p class="copyright">本系统由<a href="" target="_blank">微企联</a>强力驱动</p>
</div>
